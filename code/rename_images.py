...
def rename_images_sequentially(folder_path):
    """
    Rename all images in the specified folder to sequential names: fire1, fire2, ..., fireN.
    If images named fire... exist, they are also renamed to ensure sequential numbering.
    ...
    try:
        ...
        for i, image in enumerate(images, start=1):
            ...
            new_name = f"fire{i}{os.path.splitext(image)[1]}"  # Preserve original file extension
        ...
        print(f"The total number of images is {len(images)}, and the last image is named 'fire{len(images)}'.")
